                ...
                <div className="rule">
                    <ul className="first-nav">
                        ...
                        <li>
                            <a 
                                href="/DocDashboard"
                                className={activeLink === 'DocDashboard' ? 'active' : ''}
                                onClick={() => handleLinkClick('DocDashboard')}>
                                    Home
                            </a>
                        </li>
                        <li>
                            <a 
                                href="/DocAppointment"
                                className={activeLink === 'DocAppointment' ? 'active' : ''}
                                onClick={() => handleLinkClick('DocAppointment')}>
                                    Appointments
                            </a>
                        </li>
                        <li>
                            <a 
                                href="/DocNotifications"
                                className={activeLink === 'DocNotifications' ? 'active' : ''}
                                onClick={() => handleLinkClick('DocNotifications')}>
                                    Notifications
                            </a>
                        </li>
